...
var PermissionBusiness_1 = require("./PermissionBusiness");
var PermissionController = /** @class */ (function () {
    function PermissionController() {
    }
    PermissionController.addPermission = function (req, res) {
        var _this = this;
        new Promise(function (result, reject) { return __awaiter(_this, void 0, void 0, function () {
            var connection, repositoryPermission, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 7, 9, 12]);
                        req.body = PermissionBusiness_1.PermissionBusiness.convertToObject(req.body);
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, PermissionValidator_1.PermissionValidator.validateAddPermission(req, repositoryPermission)];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, repositoryPermission.save(req.body)];
                    case 5:
                        _a.sent();
                        return [4 /*yield*/, connection.commitTransaction()];
                    case 6:
                        _a.sent();
                        result(Messages_1.Messages.PERMISSION_SAVED);
                        return [3 /*break*/, 12];
                    case 7:
                        err_1 = _a.sent();
    ...
    PermissionController.getPermission = function (req, res) {
        var _this = this;
        new Promise(function (result, reject) { return __awaiter(_this, void 0, void 0, function () {
            var connection, repositoryPermission, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, 8, 11]);
                        req.query = PermissionBusiness_1.PermissionBusiness.convertToObject(req.query);
                        return [4 /*yield*/, ConnectionUtil_1.ConnectionUtil.getQueryRunner()];
                    case 1:
                        connection = _a.sent();
                        return [4 /*yield*/, connection.startTransaction()];
                    ...
                    case 3:
                        repositoryPermission = _a.sent();
                        return [4 /*yield*/, repositoryPermission.find(req.query)];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, connection.commitTransaction()];
                    case 5:
